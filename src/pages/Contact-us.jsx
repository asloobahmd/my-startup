...
const Contact = () => {
  return (
    <main className="min-h-[calc(100vh-90px)] pt-36 max-sm:pt-24 p-3">
      <Helmet>
        <meta charSet="utf-8" />
        <title>Contact Us - Axient Labs</title>
        <meta
          name="description"
      ...
      <div className="container max-w-6xl grid sm:grid-cols-2 items-start gap-16 bg-[#0D0D0D] border border-zinc-800 rounded-3xl backdrop-blur-[10px] bg-opacity-80 sm:px-12 p-2 py-8 sm:py-12 mb-20">
        <div className="">
          ...
          <div className="mt-6">
            ...
            {/* phone */}
            <a href="tel:+94757571333" className="text-sm block">
            ...
            {/* email */}
            <a href="mailto:axientlabs@gmail.com" className="text-sm block">
              <div className="mt-4 flex gap-x-4">
                <div className="rounded-full flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <div>
                  ...
                  <strong className="text-graytext">
                    axientlabs@gmail.com
                  </strong>
                </div>
              </div>
            </a>
