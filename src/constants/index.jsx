export const navlinks = [
  ...
  { label: "How It Works", link: "/#", to: "Process" },
...
export const services = [
  {
    ...
    desc: "Build extremely responsive web apps with the latest and cutting edge technologies.",
    icon: (
      <svg
  ...
  },
  {
    ...
    desc: "Develops business strategies and plans to achieve the desired results via the digital.",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="50"
